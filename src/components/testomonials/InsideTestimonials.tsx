...
testimonials,state
  ...
  return (
     <div  className='py-32' style={state ? { background: "url(/testimonials.webp) no-repeat top/cover"}:{backgroundColor:"transparent" }}>
      <h2 className="text-3xl xl:text-6xl text-center">CO MÓWIĄ NASI KLIENCI</h2>
